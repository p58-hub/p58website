...
const DICT = {
  en: {
    ...
    home_selected_kicker: "02 / Selected works",
    home_selected_title: "Selected works",
    home_explore_more: "Explore more",
    home_scalable_section: "04 / Scalable design",
    home_scalable_title: "Scalable design",
    ...
    home_systems_kicker: "03 / A collaborative approach",
    home_systems_title: "A collaborative approach",
    home_approach_image_alt: "Three people reviewing architectural drawings and models together in a studio",
    home_systems_body: "Every project begins with a conversation. Our clients are active participants in the design process, bringing their knowledge, needs and ambitions.",
  ...
  gr: {
    ...
    home_selected_kicker: "02 / Επιλεγμένα έργα",
    home_selected_title: "Επιλεγμένα έργα",
    home_explore_more: "Δείτε περισσότερα",
    home_scalable_section: "04 / Κλιμακούμενος σχεδιασμός",
    home_scalable_title: "Κλιμακούμενος σχεδιασμός",
    ...
    home_systems_kicker: "03 / Μια συνεργατική προσέγγιση",
    home_systems_title: "Μια συνεργατική προσέγγιση",
    home_approach_image_alt: "Τρία άτομα εξετάζουν μαζί αρχιτεκτονικά σχέδια και μακέτες σε ένα γραφείο",
    home_systems_body: "Κάθε έργο ξεκινά με μια συζήτηση. Οι πελάτες μας συμμετέχουν ενεργά στη διαδικασία σχεδιασμού, συνεισφέροντας τις γνώσεις, τις ανάγκες και τις φιλοδοξίες τους.",
